<div class="row">
	...
	<div class="well" id="project-data-panel">
		<ul class="simple-data span4">
			...
			<li><span class="fui-eye-24"></span> <?=link_to((preg_match("~^(?:ht)tps?://~i", $this->project->url)) ? $this->project->url : "http://github.com" . $this->project->url, "GitHub URL", array("target" => "_blank"))?></li>
		</ul>
		<div class="span7">
			<p>
