...
function login_user($u, $p) {
  ...
  //Makiavelo::info("Login in user: " . $__SECURITY['username_field'] . "='" . mysql_real_escape_string($u) . "' and " . $__SECURITY['password_field'] . " = '" . mysql_real_escape_string($p) . "'");
  //$usuario = $func($__SECURITY['username_field'] . "='" . mysql_real_escape_string($u) . "' and " . $__SECURITY['password_field'] . " = '" . mysql_real_escape_string($p) . "'");
